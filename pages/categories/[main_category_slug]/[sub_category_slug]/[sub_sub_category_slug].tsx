...
const SubSubCategory: NextPageWithLayout<IProps> = ({
  category_slug,
  sub_category_slug,
    ...
    <>
      ...
      <section className="min-h-screen w-full">
        <div className="max-w-8xl mx-auto mt-(--header-height) space-y-3 pb-4">
          <CategoryProducts
            category_slug={sub_sub_category_slug}
...
export const getServerSideProps = (async ({ params }) => {
  const sub_sub_category_slug = params?.sub_sub_category_slug as string;
...
SubSubCategory.getLayout = function getLayout(page: ReactElement) {
  return (
