      ...
      <div className="absolute top-6 right-6">
        ...
        >
          {({ ref }) => (
            <button
              ref={ref}
              className="flex items-center justify-between gap-2 rounded-lg bg-orange-500 px-4 py-2 font-medium text-white shadow-md"
            >
              <MessageCircleQuestionIcon className="size-5 fill-white text-orange-500" />
              <span>Need Help</span>
            </button>
          )}
        </Tooltip>
