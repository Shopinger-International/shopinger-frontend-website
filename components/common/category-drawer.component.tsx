      ...
      <div className="fixed inset-0 h-screen w-screen max-w-md shadow-md">
        ...
        >
          ...
          <div className="flex min-h-0 flex-1">
            <div className="no-scrollbar flex h-[calc(100%-var(--bottom-nav-height))] w-22 flex-col items-center overflow-y-auto border-e border-gray-300 bg-gray-50 pb-20">
            ...
            <div className="flex h-[calc(100%-var(--bottom-nav-height))] flex-1 flex-col overflow-y-auto px-4 pt-2 pb-20">
              {categories
