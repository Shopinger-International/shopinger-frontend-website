...
const OurPurpose: FC = () => {
  return (
    <section className="space-y-6 pt-8 sm:space-y-10 sm:pt-16 lg:space-y-12 lg:pt-18">
      ...
      <div className="grid gap-3 sm:gap-6 lg:grid-cols-2">
        {MISSION_VISION.map(({ title, subtitle, description, icon: Icon }) => (
          <article
            key={title}
            className="group relative flex h-full flex-col overflow-hidden rounded-xl border border-gray-300 bg-white p-3.5 sm:rounded-2xl sm:p-6 lg:p-8"
          >
            {/* Decorative Glow */}
            ...
            <div className="relative z-10 flex h-full flex-col">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <h3 className="font-bold text-gray-900 sm:mt-1 sm:text-xl lg:text-2xl">
                    {title}
                  </h3>
                </div>
              </div>
              ...
              {/* Divider */}
              <div className="my-3 h-px bg-linear-to-r from-orange-300 via-orange-100 to-transparent sm:my-6" />

              {/* Description */}
              <p className="flex-1 text-sm leading-6 text-gray-600 sm:text-base sm:leading-8">
                {description}
              </p>
            </div>
          </article>
