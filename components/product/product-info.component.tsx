      ...
      <div className="space-y-4">
        {Object.values(variant_attributes_values_group)
          ...
          .map(({ attribute: { is_visual, ...attribute }, values }) => (
            <div
              className="space-y-2"
              key={`variant-attribute-${attribute.id}`}
            >
              ...
              <div className="flex items-center gap-3">
                {Array.from(values).map((value) => {
                  ...
                  return (
                    <Link
                      href={`/${product_slug}/p/${product.id}/${variant?.id}`}
                    ...
                    >
                      {is_visual ? (
                        ...
                        >
                          <Image
                            src={
                              media_group[attribute.id as number][value][0].url
                            }
                            fill={true}
                            alt="image"
                          />
