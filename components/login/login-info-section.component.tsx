...
const LoginInfoSection: FC = () => {
  return (
    <div className="hidden min-h-136 w-max max-w-108 flex-col gap-3 bg-[url('/pattern/pattern-2.png')] bg-cover bg-no-repeat p-8 lg:flex">
      <div className="space-y-2">
        ...
        <p className="text-md font-medium text-white">
          Your order is just one call away
        </p>
      </div>
        ...
        {[
          {
            ...
            label: "Call & tell us your requirement",
            para: "Skip browsing — just say what you need.",
            icon: Van,
          },
          {
            image_src:
            ...
            label: "Expert product recommendation",
            para: "Our team helps you choose the best quality product.",
            icon: Pill,
          },
          {
            image_src:
            ...
            label: "Best coupons & offers applied",
            para: "We automatically apply the best deals to save you money.",
            icon: Smartphone,
          },
          {
            image_src:
            ...
            para: "Safe, quick, and reliable delivery to your home.",
            icon: Smartphone,
          },
        ].map((feature_data, index) => (
          <LoginFeatureCard {...feature_data} key={`feature-card-${index}`} />
        ))}
      </div>
    </div>
  );
